...
final class CaptureHistoryStoreTests: XCTestCase {
  ...
  override func setUp() {
    super.setUp()
    defaultsSuiteName = "NotinhasTests.CaptureHistoryStoreTests.\(UUID().uuidString)"
    ...
    testDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("NotinhasTests_CaptureHistoryStore_\(UUID().uuidString)", isDirectory: true)
