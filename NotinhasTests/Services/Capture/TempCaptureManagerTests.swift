...
final class TempCaptureManagerTests: XCTestCase {
  ...
  override func setUp() {
    ...
    let exportDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("NotinhasTests_Export_\(UUID().uuidString)", isDirectory: true)
  ...
  private func createExternalTestFile() throws -> URL {
    let dir = FileManager.default.temporaryDirectory
      .appendingPathComponent("NotinhasTests_External_\(UUID().uuidString)", isDirectory: true)
