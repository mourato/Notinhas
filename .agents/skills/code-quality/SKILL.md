---
name: code-quality
description: Refactoring and maintainability for Notinhas — deduplication,
dead-code removal, and keeping the fork coherent.
---
...
- Keep inherited upstream edits thin; do not rewrite Annotate wholesale for
  Notinhas needs.
