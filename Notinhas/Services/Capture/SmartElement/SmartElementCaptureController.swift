...
extension SmartElementCaptureController: SmartElementOverlayWindowDelegate {
  func smartElementOverlayWindow(_: SmartElementOverlayWindowProviding, mouseMovedAt point: CGPoint) {
  ...
  func smartElementOverlayWindowDidCancel(_: SmartElementOverlayWindowProviding) {
    cancel()
  }
}
