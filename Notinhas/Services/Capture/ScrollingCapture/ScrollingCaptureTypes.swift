...
enum ScrollingCaptureRuntimeState {
  ...
  var label: String {
    switch self {
    case .ready:
      L10n.ScrollingCapture.runtimeReady
    case .streaming:
      L10n.ScrollingCapture.runtimeCapturing
    case .previewing:
      L10n.ScrollingCapture.runtimeLive
    case .committing:
      L10n.ScrollingCapture.runtimeProcessing
    case .paused:
      L10n.ScrollingCapture.runtimePaused
    case .finalizing:
      L10n.ScrollingCapture.runtimeFinishing
    case .saving:
      L10n.ScrollingCapture.runtimeSaving
    }
  }
}
...
enum ScrollingCapturePreviewTruthState: Equatable {
  ...
  var badgeLabel: String? {
    ...
    case .ready:
      nil
    case .committedOnly:
      L10n.ScrollingCapture.badgeCaptured
    case .liveSynced:
      L10n.ScrollingCapture.badgeLive
    case .liveAhead:
      L10n.ScrollingCapture.badgeSyncing
    case .pausedRecovery:
      L10n.ScrollingCapture.badgePaused
    case .finalizing:
      L10n.ScrollingCapture.badgeFinishing
    case .saving:
...
enum ScrollingCaptureAutoScrollPolicy {
  ...
  static func canToggle(
    ...
    switch phase {
    case .capturing:
      isAutoScrolling || acceptedFrameCount > 0
