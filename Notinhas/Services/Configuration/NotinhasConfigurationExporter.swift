//
//  NotinhasConfigurationExporter.swift
//  Notinhas
//
...
@MainActor
enum NotinhasConfigurationExporter {
  ...
  private static func writeGeneral(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    writer.value(
      "export_location",
      NotinhasConfigurationPaths.collapsingHomePath(SandboxFileAccessManager.shared.exportLocationPath)
    )
  ...
  private static func writeCapture(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    private static func writeRecording(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
      ...
      writer.value("color", NotinhasConfigurationColor.hexString(from: color))
