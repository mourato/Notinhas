...
nonisolated struct DiagnosticLogEntry {
  ...
  /// Extract short filename from #fileID (e.g. "Notinhas/DiagnosticLogEntry.swift" → "DiagnosticLogEntry.swift")
  ...
  /// [14:32:05.123][INF][CAPTURE][ScreenCaptureManager.swift:168:captureFullscreen] Screenshot taken {displayID=1,
  /// scale=2.0}
