...
//  Notinhas
//
//  Manages temporary capture storage in Application Support/Notinhas/Captures.
...
final class CaptureStorageManager {
  ...
  /// URL to the captures cache directory: Application Support/Notinhas/Captures
...
enum CacheCleanupError: LocalizedError {
  ...
  var errorDescription: String? {
    switch self {
    case .operationInProgress:
      L10n.CaptureStorage.operationInProgress
    }
  }
}
