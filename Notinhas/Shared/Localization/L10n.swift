...
nonisolated enum L10n {
  ...
  enum PreferencesAdvanced {
    ...
    static let restoreDefaultsConfirmationMessage = string(
      ...
      defaultValue: "If you confirm, Notinhas will replace config.toml with default values, reset app settings, and clear cloud credentials. Saved captures are not deleted.",
  ...
  enum CloudTransfer {
    ...
    static let exportDescription = string(
      ...
      defaultValue: "Create an encrypted archive you can import on another Mac. Notinhas does not store this archive passphrase.",
    ...
    static let savePanelMessage = string(
      ...
      defaultValue: "Choose where Notinhas should save the encrypted credential archive.",
    ...
    static let chooserMessage = string(
      ...
      defaultValue: "Choose a Notinhas encrypted credential archive.",
    ...
    static let invalidArchive = string(
      ...
      defaultValue: "The selected file is not a valid Notinhas cloud credential archive.",
  ...
  enum CloudSettings {
    ...
    static let importCredentialsMessage = string(
      ...
      defaultValue: "Notinhas will load the imported values into the editor. Your current saved configuration stays unchanged until you click Save & Test.",
    ...
    static let googleFolderDescription = string(
      ...
      defaultValue: "Screenshots and videos will be saved under this folder in your Google Drive (default: Notinhas).",
    ...
    static let importEncryptedArchiveDescription = string(
      ...
      defaultValue: "Load a previously exported Notinhas cloud archive to prefill this form.",
