...
enum CropAspectRatio: String, CaseIterable, Identifiable {
  ...
  func effectiveDisplayName(isPortrait: Bool) -> String {
    ...
    case .square:
      rawValue
    case .ratio4x3:
      isPortrait ? "3:4" : rawValue
    case .ratio3x2:
      isPortrait ? "2:3" : rawValue
    case .ratio16x9:
      isPortrait ? "9:16" : rawValue
    case .ratio21x9:
      isPortrait ? "9:21" : rawValue
    }
  }
  ...
  var icon: String {
    ...
    case .square: "square"
    case .ratio4x3: "rectangle"
    case .ratio3x2: "rectangle"
    case .ratio16x9: "rectangle.ratio.16.to.9"
    case .ratio21x9: "rectangle"
    }
  }
}
