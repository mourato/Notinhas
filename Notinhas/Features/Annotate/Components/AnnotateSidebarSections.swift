...
struct BlurTypeSection: View {
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: Spacing.sm) {
      ...
      let description: String = switch state.blurType {
      case .pixelated: L10n.AnnotateUI.pixelatedBlurDescription
      case .gaussian: L10n.AnnotateUI.gaussianBlurDescription
      case .hexagonal: L10n.AnnotateUI.hexagonalBlurDescription
      case .crystallized: L10n.AnnotateUI.crystallizedBlurDescription
      case .pointillism: L10n.AnnotateUI.pointillismBlurDescription
      case .halftone: L10n.AnnotateUI.halftoneBlurDescription
      case .tape: L10n.AnnotateUI.tapeBlurDescription
      case .washi: L10n.AnnotateUI.washiBlurDescription
      }
      Text(description)
        .font(Typography.labelSmall)
        .foregroundColor(SidebarColors.labelSecondary)
