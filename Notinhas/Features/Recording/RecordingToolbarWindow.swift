...
//
  ...
  enum RecordingToolbarPlacement {
    static let screenEdgeInset = CaptureFloatingToolbarPlacement.screenEdgeInset
    static let outsideSelectionGap = CaptureFloatingToolbarPlacement.outsideSelectionGap
    static let insideSelectionBottomInset = CaptureFloatingToolbarPlacement.insideSelectionBottomInset
