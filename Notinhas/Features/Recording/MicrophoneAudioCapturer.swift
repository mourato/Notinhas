...
//
  ...
  final nonisolated class AVFoundationMicrophoneCaptureSession: MicrophoneCaptureSession {
  ...
  final nonisolated class MicrophoneAudioCapturer: NSObject, @unchecked Sendable {
