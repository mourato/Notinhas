...
enum HistoryPanelPosition: String, Codable {
  ...
  var displayName: String {
    switch self {
    case .topCenter: L10n.HistoryPanelPosition.topCenter
    case .bottomCenter: L10n.HistoryPanelPosition.bottomCenter
    case .center: L10n.HistoryPanelPosition.center
    }
  }
}
...
enum HistoryBackgroundStyle: String, CaseIterable, Codable, Identifiable {
  ...
  var displayName: String {
    switch self {
    case .hud: L10n.HistoryBackgroundStyle.hud
    case .solid: L10n.HistoryBackgroundStyle.solid
    }
  }
}
