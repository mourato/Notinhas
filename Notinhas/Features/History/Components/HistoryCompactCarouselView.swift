...
private struct HistoryCompactTrackpadScrollObserver: NSViewRepresentable {
  ...
  func makeNSView(context _: Context) -> HistoryCompactTrackpadScrollView {
  ...
  func updateNSView(_ nsView: HistoryCompactTrackpadScrollView, context _: Context) {
    nsView.isEnabled = isEnabled
    nsView.onScroll = onScroll
  }

  static func dismantleNSView(_ nsView: HistoryCompactTrackpadScrollView, coordinator _: ()) {
    nsView.cleanup()
  }
}
