...
enum NotinhasL10n {
  ...
  static let cancel = L10n.Notinhas.cancel
  static let sidePanelTitle = L10n.Notinhas.sidePanelTitle
  ...
  static let noteEditorDragHint = L10n.Notinhas.noteEditorDragHint
