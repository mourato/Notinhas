...
enum CloudUploadFloatingPosition: String, CaseIterable, Codable, Identifiable {
  ...
  var displayName: String {
    switch self {
    case .top: L10n.CloudSettings.uploadsWindowPositionTop
    case .center: L10n.CloudSettings.uploadsWindowPositionCenter
    case .bottom: L10n.CloudSettings.uploadsWindowPositionBottom
    }
  }
}
