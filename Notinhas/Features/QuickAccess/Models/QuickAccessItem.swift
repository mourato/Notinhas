...
struct QuickAccessItem: Identifiable, Equatable {
  ...
  static func == (lhs: QuickAccessItem, rhs: QuickAccessItem) -> Bool {
    lhs.id == rhs.id && lhs.processingState == rhs.processingState && lhs.thumbnailVersion == rhs
      .thumbnailVersion && lhs.cloudURL == rhs.cloudURL && lhs.isCloudStale == rhs.isCloudStale && lhs.isPinned == rhs
      .isPinned && lhs.isWindowOpen == rhs.isWindowOpen
  }
