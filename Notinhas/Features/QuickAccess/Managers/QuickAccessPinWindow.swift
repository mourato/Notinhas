...
final class QuickAccessPinWindow: NSPanel {
  ...
  static let scrollZoomSensitivityPrecise: CGFloat = 0.0015
  static let scrollZoomSensitivityCoarse: CGFloat = 0.02
  static let magnificationZoomSensitivity: CGFloat = 0.2
