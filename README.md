...
- **Advanced Settings**: TOML export/import, one-time config folder grant, safe sync-before-open, and launch-time auto-apply for portable preferences, dotfiles, backup, and machine-to-machine setup via `~/.config/snapzy/config.toml`
...
curl -fsSL https://raw.githubusercontent.com/duongductrong/Snapzy/v1.19.0/install.sh | bash
```
