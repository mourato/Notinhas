...
| 065 | Wrap quick properties instead of clipping/overlap | P1 | M | — (after 064 by policy) | DONE (`51d9615d`, merge `06ecf0dd`; thermo fix: drop ineffective ViewThatFits density switch → compact active) |
